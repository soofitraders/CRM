...
export async function GET(
  ...
  try {
    ...
    logger.error('Error fetching investor payout:', error)
...
export async function PATCH(
  ...
  try {
    ...
    logger.error('Error updating investor payout:', error)
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    logger.error('Error cancelling investor payout:', error)
    return NextResponse.json(
