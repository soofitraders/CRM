...
export async function calculateInvestorPayoutPreview(params: {
  ...
  console.log(`[InvestorPayout] Found ${investorVehicles.length} vehicles for investor ${investorId}`)
  console.log(`[InvestorPayout] Vehicle filter:`, vehicleFilter)
  ...
  console.log(`[InvestorPayout] Found ${bookings.length} bookings for period ${format(periodFrom, 'yyyy-MM-dd')} to ${format(periodTo, 'yyyy-MM-dd')}`)
  ...
  console.log(`[InvestorPayout] Found ${invoices.length} invoices for ${bookings.length} bookings`)
  ...
  console.log(`[InvestorPayout] Calculated totals:`, {
    totalRevenue,
    commissionPercent,
    commissionAmount,
    netPayout,
