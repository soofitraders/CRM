...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`Export request - Format: ${format}, User: ${user.email}, Module: EXPENSES`)
    ...
    console.log('Fetching expenses with filter:', JSON.stringify(filter))
    ...
    try {
      ...
      console.error('Error populating expenses for export:', populateError)
    ...
    console.error('Error in expenses export:', error)
    return NextResponse.json(
